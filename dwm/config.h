...
static const char *altbarcmd        = "$HOME/.config/user/scripts/bar.sh"; /* Alternate bar launch command */
...
/* TokyoNight colors */
static const char col_bg[]     = "#81d5cc";  // background
...
static const char col_grn[]    = "#ffffff";  // green
static const char col_ylw[]    = "#e0af68";  // yellow
static const char col_blu[]    = "#7aa2f7";  // blue
static const char col_mag[]    = "#899391";  // magenta
static const char col_cyn[]    = "#0db9d7";  // cyan (highlight)
static const char col_brblk[]  = "#0e1514";  // bright black
...
static Keychord *keychords[] = {
    ...
    &((Keychord){1, {{MODKEY, XK_b}},               spawn,          {.v = chromium } }), 
